...
def main():
    ...
    parser.add_argument('-s', '--hostname', type=str, default='localhost', help='Hostname running IceNLP server')
    parser.add_argument('-p', '--port', type=int, default=1234, help='Port running IceNLP server')
